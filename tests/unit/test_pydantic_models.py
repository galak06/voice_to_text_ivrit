...
from src.models.transcription import TranscriptionModel, TranscriptionEngine
...
class TestPydanticModels(unittest.TestCase):
    ...
    def test_transcription_config_defaults(self):
        ...
        self.assertEqual(config.fallback_model, TranscriptionModel.IVRIT_LARGE_V3)
        self.assertEqual(config.default_engine, TranscriptionEngine.CTRANSLATE2_WHISPER)
    ...
    def test_model_serialization(self):
        ...
        self.assertEqual(config_dict["default_model"], TranscriptionModel.IVRIT_LARGE_V3)
